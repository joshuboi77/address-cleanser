...
from src.parser import handle_edge_cases, normalize_components, parse_address
...
class TestNormalizeComponents:
    ...
    def test_normalize_zip_plus4(self):
        ...
        parsed = {"ZipCode": "78701", "ZipPlus4": "1234"}
    ...
    def test_normalize_unit_components(self):
        ...
        parsed = {"OccupancyType": "Apartment", "OccupancyIdentifier": "456"}
