...
def handle_edge_cases(address: str) -> str:
    ...
    po_box_patterns = [r"\bP\.?O\.?\s*BOX\b", r"\bPOST\s*OFFICE\s*BOX\b", r"\bPO\s*BOX\b"]
...
def _handle_repeated_label_error(
    cleaned_address: str, original_address: str, error_msg: str
) -> Dict[str, Any]:
    """
